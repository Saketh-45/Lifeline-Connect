...
//     // 1. Listen to the Match to find the Donor
//     const q = query(
...
//       const unsubDonor = onSnapshot(doc(db, "users", donorId), (docSnap) => {
//         if (docSnap.exists()) {
...
//     // 🔔 ADD: Donation completed notification listener
//     const notifQuery = query(
//       collection(db, "notifications"),
//       where("toUserId", "==", user.uid),
//       where("type", "==", "donation_completed"),
//       where("read", "==", false)
//     );
...
//       <span>
//         Donor <strong>{donationNotification.donorName}</strong> has completed
//         blood donation for <strong>{donationNotification.patientName}</strong>
//       </span>
//     </div>
